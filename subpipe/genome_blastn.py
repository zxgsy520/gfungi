...
sys.path.append(os.path.join("/Work/pipeline/gfungi/v1.0.1/"))
from gfungi.config import *
from gfungi.common import check_path, mkdir, read_files, get_version
...
def split_genome(genome, prefix, job_type, work_dir, size="5m", window="5kb"):
    ...
    task = Task(
        ...
        script="""
python {script}/genome2short.py {genome} --window {window} --minlen 1000 --maxlen 2000 >short.fasta
