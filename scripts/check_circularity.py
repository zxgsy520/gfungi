...
def do_blast(fasta, blastn):
    ...
    cmd = "%s -task megablast -subject %s -query %s -gapopen 1 -gapextend 1 -evalue 1e-100 -outfmt 7" % (blastn, fasta, fasta)
...
def add_args(parser):
    ...
    parser.add_argument("--min_overlap_ratio", type=float, default=0.97, help="")
